	...
	var ms = {
		...
		fillHtml:function(obj,args){
			return (function(){
				obj.empty();
				//填充信息
					obj.append("<p>共 "+args.listCount+" 条&nbsp;&nbsp;&nbsp;第 "+args.current+" 页/共 "+args.pageCount+" 页&nbsp;&nbsp;&nbsp;跳转到<input class='selectPageInput' name='indexS' pattern='^\d{1,3}$' type='text'>页&nbsp;&nbsp;<a href='javascript:;' class='selectPage'>&nbsp;跳转&nbsp;</a> </p>")
